...
import SupervisorProperty from '../SupervisorProperty/SupervisorProperty';
import SupervisorPropertyDetails from '../SupervisorProperty/SupervisorPropertyDetails';
import SupervisorRooms from '../SupervisorProperty/SuperVisorRooms';

const AdminDashDashboard = () => {
        ...
        <div className="dashboard-container">
            ...
            <div className="content">
                ...
                <Routes>
                    ...
                    <Route path="/properties" element={<SupervisorProperty />} />
                    <Route path="/:propertyId" element={<SupervisorPropertyDetails />} />
                    <Route path="/admins" element={<Admins />} />
                    <Route path="/users" element={<Users />} />
                    <Route path="/profile" element={<Profile />} />
                    <Route path="/rooms/:id" element={<SupervisorRooms />} />
...
export default AdminDashDashboard;

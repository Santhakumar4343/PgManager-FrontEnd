        ...
        <div className="property-container">
          ...
          <div className="property-info">
            ...
            <input
              ...
              placeholder="Pincode"
            />
            <button onClick={updatePropertyDetails} style={{  borderRadius: "20px" }}>Update Property</button>
          </div>

          <button onClick={() => setIsAddFloorsOpen(true)} style={{  borderRadius: "20px" }}>Add Floors</button>
